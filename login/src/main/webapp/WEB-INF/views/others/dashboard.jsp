		...
		<div class="row row-offcanvas row-offcanvas-left">
			<div class="col-md-3 col-lg-2 sidebar-offcanvas" id="sidebar"
				...
				<ul class="nav flex-column pl-1">
					<li class="nav-item"><a class="nav-link" href="#">Application 1</a></li>
					...
					<li class="nav-item"><a class="nav-link" href="#">Application 3</a></li>
					<li class="nav-item"><a class="nav-link" href="#">Application 4</a></li>
					<li class="nav-item"><a class="nav-link" href="">Application 5</a></li>
					<li class="nav-item"><a class="nav-link" href="">Application 6</a></li>
					<li class="nav-item"><a class="nav-link" href="">Application 7</a></li>
					<li class="nav-item"><a class="nav-link" href="">Application 8</a></li>
					<li class="nav-item"><a class="nav-link" href="">Application 9</a></li>
				</ul>
			</div>
			<!--/col-->
	...
	<div class="modal fade" id="myModal" tabindex="-1" role="dialog">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">Are you sure you want to logout completely from Dashboard.</div>
